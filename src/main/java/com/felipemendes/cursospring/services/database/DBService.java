package com.felipemendes.cursospring.services.database;
...
import com.felipemendes.cursospring.domain.Cidade;
...
import com.felipemendes.cursospring.domain.enums.Perfil;
import com.felipemendes.cursospring.domain.enums.TipoCliente;
import com.felipemendes.cursospring.repositories.CategoriaRepository;
import com.felipemendes.cursospring.repositories.CidadeRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva","felipemendes1994@gmail.com","36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa","felipemendes1994@gmail.com","31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
